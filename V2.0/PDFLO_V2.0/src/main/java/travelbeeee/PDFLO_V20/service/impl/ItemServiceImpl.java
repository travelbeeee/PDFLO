...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public void uploadItem(Long memberId, ItemDto itemUploadDto) throws NoSuchAlgorithmException, IOException {
        MultipartFile pdfFile = itemUploadDto.getPdfFile();
        MultipartFile thumbnailFile = itemUploadDto.getThumbnailFile();
    ...
    private void uploadThumbnail(MultipartFile thumbnailFile) throws NoSuchAlgorithmException, IOException {
    ...
    private void uploadPdf(MultipartFile pdfFile) throws NoSuchAlgorithmException, IOException {
